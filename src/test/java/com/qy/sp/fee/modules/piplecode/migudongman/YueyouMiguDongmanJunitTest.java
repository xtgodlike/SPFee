...
public class YueyouMiguDongmanJunitTest {
...
//	String baseURL = "http://123.56.158.156/spfee";
	...
	public void testGetSMS(){
		...
		parameters.put("mobile", "15896459982");
		...
		parameters.put("pipleId", "14830855382615142608551");
	...
	public void testLFRDONotify(){
		String response = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
				...
				+ "</player_url>"
				+ "<cpparam>qianya14830863305156449499780</cpparam>#客户计费传进的 cpparam值 "
				+ "<excode>12345</excode>#音乐基地参数回调"
				+ "</request>";
		
		try {
			String result = HttpClientUtils.doPost(baseURL+"/piple/yueyoumigudongman/sync", response, HttpClientUtils.UTF8);
			System.out.println("result:\n"+result);
		} catch (Exception e) {
			e.printStackTrace();
		}
