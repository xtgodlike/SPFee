...
public class HuaShuSmsController {

	@Resource
	private HuaShuSmsService huaShuSmsService;
	@RequestMapping(value = "/huashusms/sync" ,produces = {"application/json;charset=UTF-8"})
	@ResponseBody
	public String channelRequest(String linkid,String mobile,String port,String msg,String status,String param ,String ftime ){
		...
		try{
			...
			result = huaShuSmsService.processPaySuccess(bodyObject);
		}
		catch(Exception e){
			e.printStackTrace();
		}
