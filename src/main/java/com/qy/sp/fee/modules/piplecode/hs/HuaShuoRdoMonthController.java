...
public class HuaShuoRdoMonthController {

	@Resource
	private HuaShuoRdoV2Service huaShuoRdoV2Service;
	@RequestMapping(value = "/huashuomonth/sync" ,produces = {"application/json;charset=UTF-8"})
	@ResponseBody
	public String channelRequest(String linkid,String mobile,String port,String msg,String status,String param ,String ftime ){
		...
		try{
			...
			result = huaShuoRdoV2Service.processPaySuccess(bodyObject);
		}
		catch(Exception e){
			e.printStackTrace();
		}
