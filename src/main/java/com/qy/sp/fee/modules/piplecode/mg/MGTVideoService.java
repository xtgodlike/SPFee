package com.qy.sp.fee.modules.piplecode.mg;
...
@Service
public class MGTVideoService extends ChannelService{
	...
	private  Logger log = Logger.getLogger(MGTVideoService.class);
	@Override
	public String getPipleId() {
		return "14994842831327132282082";
	}
	...
	public JSONObject processGetSMS(JSONObject requestBody) throws Exception {
		log.info("MGTVideoService requestBody:"+requestBody);
...
//			String pipleResult = HttpClientUtils.doPost(piple.getPipleUrlA(),params,HttpClientUtils.UTF8);
			...
			log.info(" MGTVideoService getSmsResult:"+  pipleResult);
	...
	public String processPaySuccess(JSONObject requestBody) throws Exception {
		logger.info("MGTVideoService 支付同步数据:"+requestBody);
		String error = "error";
    ...
    //				notifyChannel(cp.getNotifyUrl(), order, productCode, "ok");
				...
				e.printStackTrace();
				logger.info("MGTVideoService同步处理异常："+e.getMessage());
				return "sync error";
			}
		}else{
