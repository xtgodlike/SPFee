...
public class WOShopController {

	@Resource
	private WOShopService woShopService;
	@RequestMapping(value = "/xiaowoshop/sync" ,produces = {"application/json;charset=UTF-8"})
	@ResponseBody
	public String channelRequest(String linkid,String mobile,String port,String msg,String status,String param ,String ftime ){
		...
		try{
			...
			result = woShopService.processPaySuccess(bodyObject);
		}
		catch(Exception e){
			e.printStackTrace();
		}
