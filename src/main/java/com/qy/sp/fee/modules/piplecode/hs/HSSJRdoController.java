...
public class HSSJRdoController {

	@Resource
	private HSSJRdoService hssjRdoService;
	@RequestMapping(value = "/sjrdo/sync" ,produces = {"application/json;charset=UTF-8"})
	@ResponseBody
	public String channelRequest(String linkid,String mobile,String port,String msg,String status,String param ,String ftime ){
		...
		try{
			...
			result = hssjRdoService.processPaySuccess(bodyObject);
		}
		catch(Exception e){
			e.printStackTrace();
		}
