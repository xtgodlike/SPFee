...
public class DSXDDBController {

	@Resource
	private DSXDDBService dsxddbService;
	@RequestMapping(value = "/dsxddb/sync" ,produces = {"application/json;charset=UTF-8"})
	@ResponseBody
...
//			bodyObject.put("transmissionData",transmissionData);
			...
			resultMsg = dsxddbService.processPaySuccess(requestObject);
		}
		catch(Exception e){
			e.printStackTrace();
		}
