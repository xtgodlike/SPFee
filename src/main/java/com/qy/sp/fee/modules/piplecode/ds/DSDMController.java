...
public class DSDMController {

	@Resource
	private DSDMService dsdmService;
	@RequestMapping(value = "/dsdm/sync" ,produces = {"application/json;charset=UTF-8"})
	@ResponseBody
...
//			bodyObject.put("transmissionData",transmissionData);
			...
			resultMsg = dsdmService.processPaySuccess(requestObject);
		}
		catch(Exception e){
			e.printStackTrace();
		}
